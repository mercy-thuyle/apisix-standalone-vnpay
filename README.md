...
|:----:|:----|:----|
|✅| /etc/nginx/libraries/customize/cloudian-regex/cloudian-regex.lua | /usr/local/apisix/apisix/plugins/libraries/s3-validator-bucket-name-utils.lua và /usr/local/apisix/apisix/plugins/custom/s3-normalizer-bucket-name.lua |
